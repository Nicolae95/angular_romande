...
try:
    opr = requests.get('https://10.4.4.72/api/pfc/opportunites/' , verify='/home/romande/tasks/s1empdevdb.pegase.lan.pem')
    print 'opr', opr.text
...
api = "https://10.4.4.72/api/pfc/upload-sme/"
...
response = requests.post(api, data=json.dumps({'offers': offers}), headers=headers, verify='/home/romande/tasks/s1empdevdb.pegase.lan.pem')
print response
