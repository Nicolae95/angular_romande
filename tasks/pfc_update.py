...
api = "https://10.4.4.72/api/pfc/upload-api/"
try:
...
print obj['obj'], 
response = requests.post(api, data=json.dumps(obj), headers=headers, verify='/home/romande/tasks/s1empdevdb.pegase.lan.pem')
print response
